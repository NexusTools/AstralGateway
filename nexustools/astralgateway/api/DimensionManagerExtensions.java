...
public class DimensionManagerExtensions {
    ...
    public static void transferEntityToDimension(EntityPlayerMP ent, int dim) { // will likely replace customInitDimension
...
//                        ent.setLocationAndAngles(0, 250, 0, 0, 0);
                int xr = 0;
                int yr = 40;
                int zr = 0;
                ...
                ent.setLocationAndAngles(xr, yr, zr, 0, 0);
